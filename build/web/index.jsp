<%-- 
    Document   : productos
    Created on : 20/09/2020, 01:35:03 PM
    Author     : ferch
--%>
    ...
    <body>
        ...
        <div class="container"> 
            <form action="sr_productos" method="post" class="formg-roup">
                ...
                <input type="text" name="txt_producto" id="txt_producto" class="form-control" placeholder="Ejemplo: Coca-Cola" required>
                <br>
                ...
                <input type="text" name="txt_descripcion" id="txt_descripcion" class="form-control" placeholder="Bebida" required>
                <br>
                <label for="lbl_precio_costo">Precio Costo:</label>
                <input type="number" step="0.01" name="txt_precio_costo" id="txt_precio_costo" class="form-control" placeholder="3.50" required>
                <br>
                <label for="lbl_precio_venta">Precio Venta:</label>
                <input type="number" step="0.01" name="txt_precio_venta" id="txt_precio_venta" class="form-control" placeholder="4.95" required>
                <br>
                <label for="lbl_existencia">Existencia:</label>
                <input type="number" name="txt_existencia" id="txt_existencia" class="form-control" placeholder="200" required>
                <br>
